 ...
 * enabled-model listing, {@link RoutingModule} for `buildChain`, and the provider/rate-limit modules
 * for the {@link FallbackExecutor}.
 */
@Module({
  imports: [TokensModule, ModelsModule, ProvidersModule, RateLimitModule, RoutingModule],
