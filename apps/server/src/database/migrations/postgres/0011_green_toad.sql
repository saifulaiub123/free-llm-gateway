...
DO $$ BEGIN
 ALTER TABLE "user_models" ADD CONSTRAINT "user_models_provider_key_id_user_provider_keys_id_fk" FOREIGN KEY ("provider_key_id") REFERENCES "user_provider_keys"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
